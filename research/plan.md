...
- [x] **스테이지별 몬스터 그룹핑 (Monster Grouping)**: 스테이지별로 고유한 몬스터 그룹 출현.
  - **Undead**: Zombie, Necromancer, Skeleton (Stage 1, 4...)
  - **Orc**: Ogre, Orc Shaman, Orc Warrior (Stage 2, 5...)
  - **Demon**: Chort, Imp (Stage 3, 6...)
